    ...
    return (
      <section className="border-b pb-4 mb-4">
        <button onClick={this.toggleDisplay}>
          <h3 className="font-display text-3xl sm:text-5xl mb-4 hover:text-red-200">
            + Share
          </h3>
        </button>
        <div
        ...
        >
          ...
          <p className="my-6">
            <input
              className="w-full text-red-600 p-4 rounded-md"
              type="text"
          ...
          {this.state.shareLinkMessage && (
            <div>{this.state.shareLinkMessage}</div>
          )}
        </div>
      </section>
    );
